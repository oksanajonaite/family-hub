...
public interface TaskMapper {
    ...
    @Mapping(target = "assignedToUserId", expression = "java(task.getAssignedTo() == null ? null : task.getAssignedTo().getId())")
    @Mapping(target = "assignedToDisplayName", expression = "java(task.getAssignedTo() == null ? null : task.getAssignedTo().getDisplayName())")
    @Mapping(target = "createdByUserId", expression = "java(task.getCreatedBy() == null ? null : task.getCreatedBy().getId())")
